...
#include <modvm/utils/compiler-context-analysis.h>
...
/* Attributes */
#include <modvm/utils/compiler_attributes.h>

/* Compiler specific macros. */
#ifdef __clang__
#include <modvm/utils/compiler-clang.h>
#elif defined(__GNUC__)
/* The above compilers also define __GNUC__, so order is important here. */
#include <modvm/utils/compiler-gcc.h>
#else
